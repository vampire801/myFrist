...
public class SceneManager
{
    ...
    /// 事件处理器
    /// </summary>
    public delegate void EventHandler(SceneManager sender);
    /// <summary>
    /// 离开场景事件
    /// </summary>
    ...
    public void OpenPointScene(ESCENE scene)
    {
        ...
        if (MahjongGame_SX_Changzhi.GameData.Instance && PreGamescene != null)
        {
        ...
        if (MahjongLobby_SX_Changzhi.GameData.Instance && PreGamescene != null)
        {
